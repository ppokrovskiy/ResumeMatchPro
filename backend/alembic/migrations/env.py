...
print(f"backend_directory: {os.path.abspath(backend_directory)}")
load_dotenv(dotenv_path=os.path.join(backend_directory, '..', '.env'))

# application_directory = os.path.join(backend_directory, 'application')
# print(f"application_directory: {os.path.abspath(application_directory)}")
sys.path.append(os.path.abspath(backend_directory))

from alembic import context

from application.cities.models import City, Country
